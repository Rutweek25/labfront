...
interface AdminStore {
  ...
  updateUser: (id: string | number, payload: Partial<{ name: string; email: string; role: "DOCTOR" | "TECHNICIAN" | "ADMIN"; password: string; isActive: boolean }>) => Promise<void>;
  deleteUser: (id: string | number) => Promise<void>;
  toggleUserStatus: (id: string | number, isActive: boolean) => Promise<void>;
  fetchTests: () => Promise<void>;
  createTest: (payload: { name: string; price: number }) => Promise<void>;
  updateTest: (id: string | number, payload: Partial<{ name: string; price: number }>) => Promise<void>;
  deleteTest: (id: string | number) => Promise<void>;
